...
const Apiheader = () => {
  return (
        <div className='apiheader'>
            < p className='rhyme'>The sun wakes up, banishing all fear.
...
A beautiful sight, like a dream.</p>
<p className='rhyme'>Children rise with a sleepy yawn,
Greeted by a brand new dawn.
In pajamas, they shuffle and play,
Welcoming the start of a brand new day.</p>
...
<p className='rhyme'>So, in the early light so divine,
With sleepy eyes and a stretch, we shine.
A new adventure awaits, come what may,
In the magic of morning, let's seize the day!</p>
